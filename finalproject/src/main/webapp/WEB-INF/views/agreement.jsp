...
<body style="background-color:white;">
	...
	<div class="container py-5 text-dark">
		<div class="row py-5">
			<form class="col-md-9 m-auto" method="post" role="form"	action="/user/signup" method="get" id="formsubmit">
				<div class="row">
					<div class="form-group col-md-6 mb-3" style="padding-bottom: 30px;">
						...
						<form name="form">
							<div id="one">
								...
								<textarea style="width:200%;border:1;overflow:visible;text-overflow:ellipsis;" rows=20>
								
인터넷 쇼핑몰 『주식회사 멀티헬스』회원 약관


제1조(목적)
이 약관은 주식회사 멀티헬스 회사(전자상거래 사업자)가 운영하는 주식회사 멀티헬스 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를
이용함에 있어 사이버 몰과 이용자의 권리/의무 및 책임사항을 규정함을 목적으로 합니다.
*「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)
①"몰" 이란 주식회사 멀티헬스 회사가 재화 또는 용역(이하 "재화등"이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록
...
① "몰"은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호?모사전송번호?전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 주식회사 룸페커 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
본 약관은 2022년 [4월 28일]부터 적용됩니다.


</textarea>

								<br> <input type="checkbox" name="agree_one" id="agrone" value="agreeone" class=""><label for="agrone">위의 <b>‘회원약관’</b>
									내용에 동의합니다.
								</label> <br> <br>
							...
							<div id="two">
								...
								<textarea style="width:200%;border:1;overflow:visible;text-overflow:ellipsis;" rows=20>
<수집하는 개인정보 항목>
멀티헬스는 회원가입, 비회원 구매, 상담, 불량이용의 방지 등을 위해 아래와 같은 개인정보를 수집하고 있습니다. 
- 필수항목 : 이름, 비밀번호, 이메일, 전화번호, 주소, IP Address, 결제기록

<개인정보 수집 이용목적>
멀티헬스는 수집한 개인정보를 다음의 목적을 위해 활용합니다.
...
<개인정보의 보유 및 이용기간>
멀티헬스는 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 단, 상법 및 “전자상거래등에서의 소비자보호에 관한 법률” 등 관련 법령의 규정에 의하여 다음과 같이 거래 관련 관리 의무 관계의 확인 등을 이유로 일정기간 보유하여야 할 필요가 있을 경우에는 일정기간 보유합니다.
...
- 방문(로그)에 관한 기록 : 3개월(통신비밀보호법)
									...
									<br>
								<input type="checkbox" name="agree_one" id="agrtwo"	value="agreetwo" for="" class="">
								<label for="agrtwo">위의 <b>‘개인정보 수집,이용’</b>에 동의합니다.</label>
									<br>
									<br>
								<button type="button" class="btn btn-dark btn-lg px-3" onclick="agreementcheck();">확인</button>&nbsp;&nbsp;
								<button type="button" class="btn btn-dark btn-lg px-3" onclick="location.href='/'">취소</button> <br> <br>
								<br>
							</div>
						</form>
					</div>
