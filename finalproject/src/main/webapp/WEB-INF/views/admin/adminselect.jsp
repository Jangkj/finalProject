...
<title>상품 조회</title>
    ...
    <link rel="stylesheet" href="http://localhost:8081/assets/css/testboot.css?a">
								...
								<div class="modal fade bg-white" id="delete_modal"
									...
									<div class="modal-dialog modal-lg" role="document">
										...
										<form action="admindelete" method="get"
											...
											<div class="modal-body input-group mb-2">
												<h1>삭제하시겠습니까?</h1>
												<input type="hidden" name=productnum id=productnum value=""/>
												<button type="submit" class="input-group-text bg-success text-light">
													<i class="fa fa-fw fa-check text-white" style="float:left"></i>
												</button>
