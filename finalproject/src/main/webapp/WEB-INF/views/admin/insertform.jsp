...
<title>상품 등록</title>
    ...
    <link rel="apple-touch-icon" href="http://localhost:8081/assets/img/apple-icon.png">
    <link rel="shortcut icon" type="image/x-icon" href="http://localhost:8081/assets/img/favicon.ico">

    <link rel="stylesheet" href="http://localhost:8081/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="http://localhost:8081/assets/css/templatemo.css">
    <link rel="stylesheet" href="http://localhost:8081/assets/css/custom.css">

    <!-- Load fonts style after rendering the layout styles -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Roboto:wght@100;200;300;400;500;700;900&display=swap">
    <link rel="stylesheet" href="http://localhost:8081/assets/css/fontawesome.min.css">
</head>
<body>
    <!-- Start Top Nav -->
...
<!-- 							 </div> -->
    ...
    <script src="http://localhost:8081/assets/js/jquery-migrate-1.2.1.min.js"></script>
