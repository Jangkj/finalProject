				...
				<ul class="list-unstyled templatemo-accordion">
					<li class="pb-3"><a
						...
						<ul class="collapse show list-unstyled pl-3">
							<li><a class="text-decoration-none" href="admininsert">PROTEIN</a></li>
						</ul></li>
					<li class="pb-3"><a
						class="collapsed d-flex justify-content-between h3 text-decoration-none"
						href="#"> FITNESS <i
						...
						<ul id="collapseTwo" class="collapse list-unstyled pl-3">
							<li><a class="text-decoration-none" href="#">요가매트</a></li>
							<li><a class="text-decoration-none" href="#">짐볼</a></li>
							<li><a class="text-decoration-none" href="#">밴듀/튜빙</a></li>
							<li><a class="text-decoration-none" href="#">요가복 상의</a></li>
							<li><a class="text-decoration-none" href="#">요가복 하의</a></li>
							<li><a class="text-decoration-none" href="#">요가복 세트</a></li>
							<li><a class="text-decoration-none" href="#">기타</a></li>
						</ul></li>
					<li class="pb-3"><a
						class="collapsed d-flex justify-content-between h3 text-decoration-none"
						href="#"> fitness equipment <i
							class="pull-right fa fa-fw fa-chevron-circle-down mt-1"></i>
					</a>
						<ul id="collapseThree" class="collapse list-unstyled pl-3">
							<li><a class="text-decoration-none" href="#">거꾸리</a></li>
							<li><a class="text-decoration-none" href="#">철봉/도어짐</a></li>
							<li><a class="text-decoration-none" href="#">아령/파워볼</a></li>
							<li><a class="text-decoration-none" href="#">덤벨/바벨/케틀벨</a></li>
							<li><a class="text-decoration-none" href="#">복근운동기구</a></li>
							<li><a class="text-decoration-none" href="#">기타</a></li>
						</ul></li>
					<li class="pb-3"><a
						class="collapsed d-flex justify-content-between h3 text-decoration-none"
				...
				<div div="row">
					<ul class="pagination pagination-lg justify-content-end">
						<c:choose>
							...
							<c:otherwise>
								<a href="productlist?page=${pageInfo.page-1}&search_text=${search_text}">[이전]</a>&nbsp;
				        </c:otherwise>
						...
						<c:choose>
							...
							<c:otherwise>
								<a href="productlist?page=${pageInfo.page+1}&search_text=${search_text}">[다음]</a>
							</c:otherwise>
						</c:choose>
					</ul>
				</div>
